...
export declare namespace firebasedynamiclinks_v1 {
    ...
    class Resource$V1 {
         ...
         * @return {object} Request object
         */
        reopenAttribution(params?: Params$Resource$V1$Reopenattribution, options?: MethodOptions): AxiosPromise<Schema$GetIosReopenAttributionResponse>;
    ...
    interface Params$Resource$V1$Reopenattribution {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
