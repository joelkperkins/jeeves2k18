...
export declare namespace jobs_v3p1beta1 {
    ...
    interface Schema$CustomRankingInfo {
         ...
         * ranking position.  An error will be thrown if not specified.
         */
    ...
    interface Schema$SearchJobsRequest {
         ...
         * put at the end of search results. * &quot;custom_ranking desc&quot;: By
    ...
    class Resource$Projects$Clientevents {
         ...
         * @return {object} Request object
         */
        create(params?: Params$Resource$Projects$Clientevents$Create, options?: MethodOptions): AxiosPromise<Schema$ClientEvent>;
    ...
    interface Params$Resource$Projects$Clientevents$Create {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
